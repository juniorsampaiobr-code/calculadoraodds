# 📊 Calculadora de Arbitragem & Freebets (Calculadora de Odds)
...
- **HTML5**
- **CSS3** (CSS Variables, Flexbox, Grid, Design Responsivo)
- **JavaScript** (Vanilla JS)

## 💻 Como Executar

Basta clonar o repositório e abrir o arquivo `index.html` em qualquer navegador web:

```bash
# Clonar o repositório
git clone https://github.com/juniorsampaiobr-code/calculadoraodds.git
...
---
Desenvolvido com foco em precisão e facilidade de uso para apostadores e analistas de arbitragem.
